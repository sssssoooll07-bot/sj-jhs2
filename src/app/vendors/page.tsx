...
function PurchaseOrderModal({ vendor, onClose }: { vendor: Vendor; onClose: () => void }) {
  ...
  function bodyHtml() {
    ...
    return `
      ...
      <p class="sec">■ 발주내역</p>
      <table class="items">
        <colgroup><col style="width:7%"><col style="width:22%"><col style="width:18%"><col style="width:5%"><col style="width:6%"><col style="width:10%"><col style="width:10%"><col style="width:10%"><col style="width:12%"></colgroup>
        <thead>
